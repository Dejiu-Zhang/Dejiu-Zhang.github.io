...
export function initializeMotion(reader){
 ...
 let phase=-Math.PI/8,hover=false,mouse=null,wallX=0,wallY=0,wallTargetX=0,wallTargetY=0,drag=null;
 ...
 return function animate(now,dt){
  ...
  const paused=hover||focus||reduced.matches||reader.isOpen;orbit.dataset.paused=String(paused);orbit.dataset.phase=phase.toFixed(4);
